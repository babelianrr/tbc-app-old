...
<div class="container">
  ...
  <div class="card mb-3" style="max-width: 1080px;">
    <div class="row g-0">
      <div class="col-md-4">
        <img class="img-fluid img-thumbnail" src="https://res.cloudinary.com/dxlpys5st/image/upload/v1648098833/c2019/riko_mmxcvv.png" alt="<?= $card['slug'] ?>">
      </div>
      <div class="col-md-8">
        <div class="card-body">
          ...
          <p class="card-text">
            &#10112; Saat turnku dimulai, aktifkan <a class="text-info" data-bs-toggle="tooltip" title="<?= $detail['99'] ?>">buku skill Riko</a> / Saat permainan dimulai, marble awal meningkat <span class="text-danger">100%</span>.
            <br>
